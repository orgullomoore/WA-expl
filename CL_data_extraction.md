...
## The RCW download
This was easy enough. With the assistance of AI vibe coding, I created rcw_spider.py, which crawled the Legislature's website to get the [https://huggingface.co/datasets/orgullomoore/RCW](~51.6k code sections) and put those in a sqlite3 file. I later converted this to a parquet file and uploaded it to Hugging Face as a dataset.
